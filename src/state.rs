...
pub struct ZoneStatus {
    ...
    pub violation_at: Option<DateTime<Local>>,
    pub tamper_state: bool,
    pub tamper_at: Option<DateTime<Local>>,
    pub alarm_state: bool,
    pub alarm_at: Option<DateTime<Local>>,
    pub tamper_alarm_state: bool,
    pub tamper_alarm_at: Option<DateTime<Local>>,
    pub alarm_memory_state: bool,
    pub alarm_memory_at: Option<DateTime<Local>>,
    pub tamper_alarm_memory_state: bool,
    pub tamper_alarm_memory_at: Option<DateTime<Local>>,
    pub bypass_state: bool,
    pub bypass_at: Option<DateTime<Local>>,
    pub no_violation_trouble_state: bool,
    pub no_violation_trouble_at: Option<DateTime<Local>>,
    pub long_violation_trouble_state: bool,
    pub long_violation_trouble_at: Option<DateTime<Local>>,
}
...
pub struct Zone {
    ...
    pub tamper_state: bool,
    pub tamper_read_at: Option<DateTime<Local>>,
    pub alarm_state: bool,
    pub alarm_read_at: Option<DateTime<Local>>,
    pub violation_state: bool,
    pub violation_read_at: Option<DateTime<Local>>,
    pub tamper_alarm_state: bool,
    pub tamper_alarm_read_at: Option<DateTime<Local>>,
    pub alarm_memory_state: bool,
    pub alarm_memory_read_at: Option<DateTime<Local>>,
    pub tamper_alarm_memory_state: bool,
    pub tamper_alarm_memory_read_at: Option<DateTime<Local>>,
    pub bypass_state: bool,
    pub bypass_read_at: Option<DateTime<Local>>,
    pub no_violation_trouble_state: bool,
    pub no_violation_trouble_read_at: Option<DateTime<Local>>,
    pub long_violation_trouble_state: bool,
    pub long_violation_trouble_read_at: Option<DateTime<Local>>,
...
impl Zone {
    pub fn new(id: u16) -> Self {
        ...
        Self {
            ...
            violation_read_at: None,
            tamper_alarm_state: false,
            tamper_alarm_read_at: None,
            alarm_memory_state: false,
            alarm_memory_read_at: None,
            tamper_alarm_memory_state: false,
            tamper_alarm_memory_read_at: None,
            bypass_state: false,
            bypass_read_at: None,
            no_violation_trouble_state: false,
            no_violation_trouble_read_at: None,
            long_violation_trouble_state: false,
            long_violation_trouble_read_at: None,
            reaction: None,
            partition: None,
            params_read_at: None,
        }
...
pub struct Partition {
    ...
    pub armed_suppressed_at: Option<DateTime<Local>>,
    pub armed_really: bool,
    pub armed_really_at: Option<DateTime<Local>>,
    pub alarm: bool,
    pub alarm_at: Option<DateTime<Local>>,
    pub alarm_memory: bool,
    pub alarm_memory_at: Option<DateTime<Local>>,
    pub entry_time: bool,
    pub entry_time_at: Option<DateTime<Local>>,
    pub exit_time_gt_10s: bool,
    pub exit_time_gt_10s_at: Option<DateTime<Local>>,
    pub exit_time_lt_10s: bool,
    pub exit_time_lt_10s_at: Option<DateTime<Local>>,
...
impl Partition {
    pub fn new(id: u16) -> Self {
        ...
        Self {
            ...
            armed_suppressed_at: None,
            armed_really: false,
            armed_really_at: None,
            alarm: false,
            alarm_at: None,
            alarm_memory: false,
            alarm_memory_at: None,
            entry_time: false,
            entry_time_at: None,
            exit_time_gt_10s: false,
            exit_time_gt_10s_at: None,
            exit_time_lt_10s: false,
            exit_time_lt_10s_at: None,
            partition_type: None,
            object_number: None,
            options: None,
            auto_arm_defer: None,
...
pub struct Output {
    ...
    pub name_read_at: DateTime<Local>,
    pub state: bool,
    pub state_read_at: Option<DateTime<Local>>,
