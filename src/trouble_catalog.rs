...
impl TroubleType {
    ...
    pub fn address(&self) -> Option<TroubleAddress> {
        match self {
            ...
            Self::EthmPingTrouble(id) => Some(TroubleAddress::One(*id as u16)),
            Self::EthmServerIdError(id) => Some(TroubleAddress::One(*id as u16)),
            Self::EthmSatelServerConnectionError(id) => Some(TroubleAddress::One(*id as u16)),
